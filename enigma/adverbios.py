...
def processar_adv(texto):
    ...
    contagem_adverbios = Counter(adverbios).most_common(20)
    
    resultado_json = {
        'adverbios': {adverbio: contagem for adverbio, contagem in contagem_adverbios}
    }
