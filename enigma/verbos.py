...
def processar_verb(texto):
    ...
    contagem_verbos = Counter(verbs).most_common(20)
    
    resultado_json = {
        'verbos': {verbo: contagem for verbo, contagem in contagem_verbos}
    }
...
resultado = processar_verb(texto)
print(resultado)
